...
public class GitHubSourceConnector extends SourceConnector {
    ...
    public void start(Map<String, String> map) {
        // map will be map of your config parameters
        // will read from GitHubSourceConnectorExample.properties
        // because GitHubSourceConnectorExample.properties has connector.class=org.jeremy.kafka.GitHubSourceConnector
    ...
    public List<Map<String, String>> taskConfigs(int i) {
        // i is the max.tasks
        // here we only allow 1.
        // Define the individual task configurations that will be executed.
        ArrayList<Map<String, String>> configs = new ArrayList<>(1);
        configs.add(config.originalsStrings());

        // basically we add 1 copy of config into configs, because we only allow 1 task atm
        return configs;
    }
